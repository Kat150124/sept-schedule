...
const DEFAULT_SCHEDULE = [
  ...
  { date: '2026-09-04', label: '9/4', tags: [{ type: 'training', text: '培訓課' }, { type: 'compete', text: '比賽排練' }] },
  { date: '2026-09-05', label: '9/5', tags: [{ type: 'rest', text: '' }] },
  { date: '2026-09-06', label: '9/6', tags: [{ type: 'rest', text: '' }] },

  { date: '2026-09-07', label: '9/7', tags: [{ type: 'required', text: '①StreetJazz-茶葉' }, { type: 'required', text: '②LyricalJazz-伊娜' }, { type: 'compete', text: '比賽排練' }] },
  ...
  { date: '2026-09-11', label: '9/11', tags: [{ type: 'training', text: '培訓課' }, { type: 'compete', text: '比賽排練' }] },
  ...
  { date: '2026-09-16', label: '9/16', tags: [{ type: 'compete', text: '比賽排練' }] },
  { date: '2026-09-17', label: '9/17', tags: [{ type: 'required', text: '極簡質感Jazz-伊娜' }, { type: 'compete', text: '比賽排練' }] },
  ...
  { date: '2026-09-21', label: '9/21', tags: [{ type: 'required', text: '①Jazz-Emma' }, { type: 'required', text: '②LyricalJazz-伊娜' }, { type: 'compete', text: '比賽排練' }] },
  { date: '2026-09-22', label: '9/22', tags: [{ type: 'rest', text: '' }] },
  { date: '2026-09-23', label: '9/23', tags: [] },
  { date: '2026-09-24', label: '9/24', tags: [{ type: 'compete', text: '比賽排練' }] },
  { date: '2026-09-25', label: '9/25', tags: [] },
  { date: '2026-09-26', label: '9/26', tags: [] },
  { date: '2026-09-27', label: '9/27', tags: [{ type: 'rest', text: '' }] },

  { date: '2026-09-28', label: '9/28', tags: [{ type: 'required', text: '①StreetJazz-茶葉' }, { type: 'required', text: '②LyricalJazz-翊芳' }, { type: 'compete', text: '比賽排練' }] },
  { date: '2026-09-29', label: '9/29', tags: [{ type: 'rest', text: '' }] },
  { date: '2026-09-30', label: '9/30', tags: [] },
  { date: '2026-10-01', label: '10/1', tags: [{ type: 'compete', text: '比賽排練' }], nextMonth: true },
